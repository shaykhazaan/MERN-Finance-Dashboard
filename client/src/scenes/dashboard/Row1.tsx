...
import { ResponsiveContainer,  Line, Legend, LineChart, AreaChart, BarChart, Bar, CartesianGrid, XAxis, YAxis, Tooltip, Area } from 'recharts';
  ...
  return (
    ...
    <DashboardBox gridArea="a">
      <BoxHeader 
        ...
        subtitle= "top line represensts revenue, bottom line represents expenses"
        sideText= "+4%"
      />
